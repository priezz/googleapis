...
buildWebfont() {
  ...
  if (buildCounterWebfont < 3) {
    o.category = "foo";
    o.family = "foo";
    o.files = buildUnnamed1414();
    o.kind = "foo";
    o.lastModified = core.DateTime.parse("2002-02-27T14:01:02Z");
    o.subsets = buildUnnamed1415();
    o.variants = buildUnnamed1416();
    o.version = "foo";
  }
  buildCounterWebfont--;
  return o;
...
checkWebfont(api.Webfont o) {
  ...
  if (buildCounterWebfont < 3) {
    ...
    checkUnnamed1414(o.files);
    unittest.expect(o.kind, unittest.equals('foo'));
    unittest.expect(o.lastModified,
        unittest.equals(core.DateTime.parse("2002-02-27T00:00:00")));
    checkUnnamed1415(o.subsets);
    checkUnnamed1416(o.variants);
...
checkUnnamed1417(core.List<api.Webfont> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkWebfont(o[0]);
  checkWebfont(o[1]);
}
